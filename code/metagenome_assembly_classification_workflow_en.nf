...
process CALCULATE_ABUNDANCE_MEGAHIT {
    ...
    # Search for libbz2.so in system and create symbolic link
...
print("=== Calculating RPM and RPKM for MEGAHIT contigs: ${sample} ===")

# 1. Get length of each contig
contig_lengths = {}
...
# 2. Count mapped reads for each contig using samtools idxstats
...
try:
    ...
    print(f"Error: samtools idxstats failed")
...
print(f"Abundance calculation completed: ${sample} (MEGAHIT)")
PYTHON_SCRIPT
    """
}
...
print("=== Calculating RPM and RPKM for SPAdes contigs: ${sample} ===")
...
print(f"Abundance calculation completed: ${sample} (SPAdes)")
PYTHON_SCRIPT
    """
}
